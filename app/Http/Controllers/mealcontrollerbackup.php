    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'portion_size' => 'nullable|numeric|min:1',
            ...
            if (!$profile) {
                Log::error('User profile not found', ['user_id' => auth()->id()]);
                return redirect()->back()->with('error', 'User profile not found. Please complete your profile.')->withInput();
            }
            ...
            $portionSize = $request->input('portion_size', 100);
